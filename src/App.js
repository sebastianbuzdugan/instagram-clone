      ...
      >
        <div style={modalStyle} className={classes.paper}>
          <form className="app__signup">
            ...
            <Input 
              type="text"
              placeholder={lang ? "Nume de utilizator":"username"}
              value={username}
            ...
            <Input 
              placeholder={lang ? "Parola":"password"}
              type="password"
              value={password}
              onChange={(e) => setPassword(e.target.value)}
            />
            <Button type="submit" onClick={signUp}>{lang ? "Inscriere":"Sign Up"}</Button>
        ...
        <div style={modalStyle} className={classes.paper}>
          <form className="app__signup">
            ...
            <Input 
              ...
              onChange={(e) => setPassword(e.target.value)}
            />
            <Button type="submit" onClick={signIn}>{lang ? "Conectare":"Sign In"}</Button>
      ...
      <header className="app__header">
        ...
        <div className="app__loginContainer">
              ...
              <div className="loginLeft">
                { user ? (
                  <Button onClick={() => auth.signOut()}>{lang ? "Deconectare":"Logout"}</Button>
                ) : (
                  <Button onClick={() => toggleLang()}>{lang ? "EN":"RO"}</Button>
                )
                }
            ...
            <div className="loginRight">
              <Button  aria-controls="fade-menu" aria-haspopup="true" > 
                <MenuPopupState 
                  ...
                  labeltopass={lang ? "English Version" : "Versiunea in Romana"}
                  signout={() => auth.signOut()}
                  signoutlabel={lang ? "Deconectare":"Logout"}
                  signin={() => setOpenSignIn(true)}
                  signinlabel={lang ? "Conectare" : "Sign In"}
                  signup={() => setOpen(true)}
                  signuplabel={lang ? "Inregistrare" : "Sign Up"}
                />
              </Button>
          ...
          <div className="footer__icons">
              ...
              <div className="footer__middle">
                  <Button onClick={() => setOpenSignIn(true)}>
                    {lang ? "CONECTARE":"SIGN IN"} &nbsp;&nbsp;
                  </Button> 
                  <Button onClick={() => setOpen(true)}>
                    {lang ? "INSCRIERE":"SIGN UP"}
                  </Button>
